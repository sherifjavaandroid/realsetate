...
class ChatHistory extends PsObject<ChatHistory> {
  ...
  ChatHistory fromMap(dynamic dynamicData) {
    ...
    return ChatHistory(
      ...
      latestChatMessage: dynamicData['latest_chat_message'],
  ...
  Map<String, dynamic>? toMap(dynamic object) {
    if (object != null) {
      ...
      data['latest_chat_message'] = object.latestChatMessage;
  ...
  bool get hasBuyerUnreadCount {
    return buyerUnreadCount != null &&
        buyerUnreadCount != '' &&
        buyerUnreadCount != '0';
  }

  bool get hasSellerUnreadCount {
    return sellerUnreadCount != null &&
        sellerUnreadCount != '' &&
        sellerUnreadCount != '0';
  }
}
