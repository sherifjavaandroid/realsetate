...
class ItemPaidHistoryParameterHolder
  ...
  ItemPaidHistoryParameterHolder({
    ...
    required this.inAppPurchasedProductId
  });
  ...
  final String? inAppPurchasedProductId;
  ...
  Map<String, dynamic> toMap() {
    ...
    map['product_id'] = inAppPurchasedProductId;
  ...
  ItemPaidHistoryParameterHolder fromMap(dynamic dynamicData) {
    return ItemPaidHistoryParameterHolder(
      ...
      inAppPurchasedProductId: dynamicData['product_id']
    );
  }
  ...
  String getParamKey() {
    ...
    if (isPaystack != '') {
     ...
     if (inAppPurchasedProductId != '') {
      key += inAppPurchasedProductId!;
    }
    return key;
  }
}
