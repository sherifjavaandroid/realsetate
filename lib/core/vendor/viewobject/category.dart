...
class Category extends PsObject<Category> {
  ...
  Category fromMap(dynamic dynamicData) {
    // if (dynamicData != null) {
    return Category(
        catId: dynamicData['id'],
        catName: dynamicData['name'],
        catOrdering: dynamicData['ordering'],
  ...
  Map<String, dynamic>? toMap(Category? object) {
    if (object != null) {
      ...
      data['id'] = object.catId;
      data['name'] = object.catName;
      data['ordering'] = object.catOrdering;
