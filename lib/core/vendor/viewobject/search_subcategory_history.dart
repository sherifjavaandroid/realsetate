...
class SearchSubCategoryHistory extends PsObject<SearchSubCategoryHistory> {
  SearchSubCategoryHistory({
    this.id,
    this.keyword,
    this.userId,
    this.type,
  ...
  @override
  SearchSubCategoryHistory fromMap(dynamic dynamicData) {
    //if (dynamicData != null) {
    return SearchSubCategoryHistory(
      id: dynamicData['id'],
  ...
  @override
  List<SearchSubCategoryHistory> fromMapList(List<dynamic> dynamicDataList) {
    final List<SearchSubCategoryHistory> favouriteProductMapList = <SearchSubCategoryHistory>[];
