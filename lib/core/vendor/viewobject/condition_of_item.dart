...
class ConditionOfItem extends PsObject<ConditionOfItem> {
  ...
  @override
  ConditionOfItem fromMap(dynamic dynamicData) {
    // if (dynamicData != null) {
  ...
  @override
  List<ConditionOfItem> fromMapList(List<dynamic> dynamicDataList) {
    final List<ConditionOfItem> userLoginList = <ConditionOfItem>[];
