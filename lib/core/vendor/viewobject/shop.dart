...
class Shop extends PsObject<Shop> {
  ...
  List<String> get openAndCloseMondayHours {
    return <String>[
      shopSchedules!.mondayOpenHour!,
      shopSchedules!.mondayCloseHour!
    ];
  }

  List<String> get openAndCloseTuesdayHours {
    return <String>[
      shopSchedules!.tuesdayOpenHour!,
      shopSchedules!.tuesdayCloseHour!
    ];
  }

  List<String> get openAndCloseWednesdayHours {
    return <String>[
      shopSchedules!.wednesdayOpenHour!,
      shopSchedules!.wednesdayCloseHour!
    ];
  }

  List<String> get openAndCloseThursdayHours {
    return <String>[
      shopSchedules!.thursdayOpenHour!,
      shopSchedules!.thursdayCloseHour!
    ];
  }

  List<String> get openAndCloseFridayHours {
    return <String>[
      shopSchedules!.fridayOpenHour!,
      shopSchedules!.fridayCloseHour!
    ];
  }

  List<String> get openAndCloseSaturdayHours {
    return <String>[
      shopSchedules!.saturdayOpenHour!,
      shopSchedules!.saturdayCloseHour!
    ];
  }

  List<String> get openAndCloseSundayHours {
    return <String>[
      shopSchedules!.sundayOpenHour!,
      shopSchedules!.sundayCloseHour!
    ];
  }
}
