...
class AddNewBillingAddressRepository extends PsRepository {
  AddNewBillingAddressRepository({required PsApiService psApiService}) {
  ...
  Future<PsResource<ApiStatus>> postData({
    ...
    final PsResource<ApiStatus> _resource =
        await _psApiService.postNewBillingAddress(
