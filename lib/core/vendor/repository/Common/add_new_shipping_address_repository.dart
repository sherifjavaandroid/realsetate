...
class AddNewShippingAddressRepository extends PsRepository {
  AddNewShippingAddressRepository({required PsApiService psApiService}) {
  ...
  Future<PsResource<ApiStatus>> postData({
    ...
    final PsResource<ApiStatus> _resource =
        await _psApiService.postNewShippingAddress(
