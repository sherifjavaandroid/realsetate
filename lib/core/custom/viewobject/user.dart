...
import '../../vendor/viewobject/common/ps_object.dart';
import '../../vendor/viewobject/rating_detail.dart';

class CUser extends PsObject<CUser> {
  CUser(
      {this.userId,
      this.userIsSysAdmin,
      this.facebookId,
  ...
  @override
  bool operator ==(dynamic other) => other is CUser && userId == other.userId;
  ...
  @override
  CUser fromMap(dynamic dynamicData) {
    if (dynamicData != null) {
      return CUser(
  ...
  @override
  Map<String, dynamic>? toMap(CUser object) {
    // if (object != null) {
  ...
  @override
  List<CUser> fromMapList(List<dynamic> dynamicDataList) {
    final List<CUser> subUserList = <CUser>[];
  ...
  @override
  List<Map<String, dynamic>?> toMapList(List<CUser?> objectList) {
    final List<Map<String, dynamic>?> mapList = <Map<String, dynamic>?>[];
    // if (objectList != null) {
    for (CUser? data in objectList) {
      if (data != null) {
