...
class CustomProductDetailList extends StatefulWidget {
  @override
  State<CustomProductDetailList> createState() => _CustomDetailInfoViewState();
}

class _CustomDetailInfoViewState extends State<CustomProductDetailList> {
  ...
  final List<String> removeIdList = <String>[
    'ps-itm00032', // item address

    'ps-itm00031', //estate
    'ps-itm00002', //postType
    'ps-itm00003', //priceType
    ...
    return SliverToBoxAdapter(
      child: Consumer<ItemEntryFieldProvider>(builder: (BuildContext context,
        ...
        if (!provider.hasData) {
          ...
          //need to create a new list for custom fields widget, if not remove ids will also affect in them
          if (provider.itemEntryField.data?.customField != null)
            customFieldList =
                provider.itemEntryField.data?.customField!.toList() ??
                    <CustomField>[];
