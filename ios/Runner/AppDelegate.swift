...
//     BTAppContextSwitcher.setReturnURLScheme("com.panaceasoft.psxrec.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.panaceasoft.psxrec.braintree") == .orderedSame {
